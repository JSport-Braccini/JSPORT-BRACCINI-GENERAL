  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 overflow-hidden relative">
      ...
      <div className="w-full max-w-[420px] flex flex-col gap-6 relative z-10">
        ...
        {/* Login Form */}
        <div className="glass-panel p-6 md:p-8 rounded-[2.5rem] border border-white/5 shadow-2xl animate-pop">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-black tracking-tighter text-white italic leading-none">J<span className="text-indigo-500">SPORT</span></h1>
            <p className="text-slate-500 mt-1 font-bold uppercase tracking-widest text-[9px]">GESTIÓN DE TORNEOS PRO</p>
          </div>
        ...
        <div className="bg-slate-900/60 backdrop-blur-md border border-white/5 p-6 md:p-8 rounded-[2.5rem] shadow-2xl animate-pop" style={{animationDelay: '0.1s'}}>
           <div className="flex items-center gap-4 mb-5">
              ...
              <div className="text-left">
                 ...
                 <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">CONÉCTATE A LA NUBE JSPORT</p>
              </div>
           </div>
        ...
        <div className="text-center">
          <p className="text-[9px] text-slate-600 font-black uppercase tracking-[0.2em] italic">JSPORT GLOBAL NETWORK v2.5</p>
        </div>
      </div>
    </div>
  );
